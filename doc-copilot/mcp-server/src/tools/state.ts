...
export async function saveState({ project_path, state, render }: z.infer<typeof saveStateSchema>) {
...
export async function loadState({ project_path }: z.infer<typeof loadStateSchema>) {
